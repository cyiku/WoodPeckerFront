                ...
                <div className="card card-register mx-auto mt-5">
                    ...
                    <div className="card-body">
                        <form>
                            <div className="form-group">
                                <label>用户名</label>
                                <input className="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter username" />
                            </div>
                            <div className="form-group">
                            ...
                            <Link className="btn btn-primary btn-block" to="/login">注册</Link>
                        </form>
                        <div className="text-center">
                            <Link className="d-block small mt-3" to="/login">登录</Link>
                        </div>
                    </div>
                </div>
            </div>
