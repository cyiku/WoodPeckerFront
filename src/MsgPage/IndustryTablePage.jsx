...
class IndustryTablePage extends React.Component {
    ...
    componentDidMount(){
        ...
        if (this.props.collection['industry'] === null) {
    ...
    render() {
        ...
        const type = "industry";
        const columns = this.state.industryColumns;
        const title = "行业动态";
        const collection = this.props.collection['industry'];
        return (
...
const connectedIndustryTablePage = connect(mapStateToProps)(IndustryTablePage);
export { connectedIndustryTablePage as IndustryTablePage };
