...
class BusinessTablePage extends React.Component {
...
const connectedBusinessTablePage = connect(mapStateToProps)(BusinessTablePage);
export { connectedBusinessTablePage as BusinessTablePage };
